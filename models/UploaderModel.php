...
namespace Delement\ComponentUploader\models;


use Delement\ComponentUploader\interfaces\UploadedFileInterface;
use Delement\ComponentUploader\models\UploadedFileModel;
use Yii;
use yii\base\Model;
